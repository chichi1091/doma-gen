...
public class EntityPropertyDesc {
   ...
   * プロパティクラス名を設定します。
   *
   * @param propertyClassName プロパティクラス名
   */
   ...
   * 識別子の生成方法を示す方法を設定します。
   *
   * @param generationType 識別子の生成方法を示す方法、生成しない場合 {@code null}
   */
   ...
   *
   * @param number 数値を表す場合 {@code true}
   */
   ...
   *
   * @param timestamp タイムスタンプを表す場合 {@code true}
   * @since 1.11.0
   */
   ...
   * エンティティのクラス名を設定します。
   *
   * @param entityClassName エンティティのクラス名
   */
