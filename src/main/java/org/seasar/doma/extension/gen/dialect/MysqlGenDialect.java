...
public class MysqlGenDialect extends StandardGenDialect {
   ...
   * インスタンスを構築します。
   *
   * @see <a href="https://dev.mysql.com/doc/refman/5.6/ja/data-types.html">MySQL 5.6 リファレンスマニュアル /
   *     データ型</a>
   * @see <a
   *     href="https://dev.mysql.com/doc/connector-j/en/connector-j-reference-type-conversions.html">MySQL
   *     Connector/J Developer Guide / Java, JDBC and MySQL Types</a>
   */
